/**
 * @registry-id: eitjeV2ApiClient
 * @created: 2026-01-22T00:00:00.000Z
 * @last-modified: 2026-01-24T00:00:00.000Z
 * @description: Eitje V2 HTTP client helpers (fetch + axios) with date-range validation
 * @last-fix: [2026-01-24] Added metadata header for validation
 *
 * @imports-from:
 *   - app/lib/eitje/v2-types.ts => EitjeCredentials, EITJE_DATE_LIMITS
 *   - axios => GET-with-body support
 *
 * @exports-to:
 *   ✓ app/api/eitje/v2/sync/route.ts => uses fetchEitje* functions to pull data
 */
