/**
 * @registry-id: ConnectionsDisplayComponent
 * @created: 2026-01-16T00:00:00.000Z
 * @last-modified: 2026-01-16T00:00:00.000Z
 * @description: Connections display component using microcomponents and connectionService
 * @last-fix: [2026-01-16] Refactored to use Card, Badge microcomponents + connectionService
 * 
 * @imports-from:
 ...
 * 
 * @exports-to:
 *   ✓ app/components/** => Components use ConnectionsDisplay for displaying connections
 */
...
export default function ConnectionsDisplay({ type, id }: ConnectionsDisplayProps) {
  ...
  if (!connections) {
    return (
      <div className="text-center py-12 text-muted-foreground">No connections found</div>
    )
  }
