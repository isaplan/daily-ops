/**
 * @registry-id: SalesDataViewComponent
 * @created: 2026-01-27T00:00:00.000Z
 * @last-modified: 2026-01-27T00:00:00.000Z
 * @description: Sales data view component - displays raw sales data in a table
 ...
 * 
 * @exports-to:
 *   ✓ app/daily-ops/inbox/test-data/page.tsx => Shows sales data
 */
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Raw sales data from inbox attachments (no transformations)
        </p>
      </div>
      <TestDataTable
        rows={state.data}
