 ...
 * @last-fix: [2026-01-24] Moved to /daily-work/dashboard/location and updated links
 */
...
export default function LocationDashboard() {
  const { user, loading: authLoading, canView, isManager, isAdmin, canViewOtherLocations } = useAuth();
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  You can also view the <a href="/daily-work/dashboard/company" className="text-blue-600 underline">consolidated company view</a>.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
