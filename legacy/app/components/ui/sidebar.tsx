    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper flex min-h-svh w-full has-[[data-side=sidebar]:animate-in]:duration-200",
            className
          )}
          ref={ref}
          {...props}
      ...
      >
        ...
        >
          <div
            ...
            data-state={state}
            className={cn(
              "flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:border-r group-data-[variant=floating]:border-sidebar-border",
              "group-data-[variant=floating]:bg-sidebar group-data-[variant=inset]:bg-sidebar",
    ...
    return (
      <main
        ...
        className={cn(
          ...
          "peer-data-[collapsible=icon]:md:ml-[calc(var(--sidebar-width-icon)_-_1px)]",
          className
        )}
        {...props}
      />
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        data-sidebar="header"
        className={cn("flex h-16 shrink-0 items-center gap-2 border-b border-sidebar-border px-3", className)}
        {...props}
      />
    )
  }
...
const SidebarTitle = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        data-sidebar="title"
        className={cn("flex-1 font-semibold text-sidebar-foreground", className)}
        {...props}
      />
    )
  }
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        data-sidebar="footer"
        className={cn("flex h-16 shrink-0 items-center gap-2 border-t border-sidebar-border px-3", className)}
        {...props}
      />
    )
  }
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn("my-1 w-full shrink-0 bg-sidebar-border", className)}
      {...props}
    />
  )
})
