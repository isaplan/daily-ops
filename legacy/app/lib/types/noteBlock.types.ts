/**
 * @registry-id: noteBlockTypes
 * @created: 2026-02-19T00:00:00.000Z
 * @last-modified: 2026-02-19T00:00:00.000Z
 * @description: Block-based note structure - each block has content + todos below
 *
 * @exports-to:
 *   ✓ app/lib/utils/blockTodoParser.ts
...
export function parseBlockNoteContent(content: string): NoteBlock[] | null {
  ...
  try {
    ...
    if (doc.version === 2 && Array.isArray(doc.blocks)) return doc.blocks
  } catch {
    return null
  }
  return null
