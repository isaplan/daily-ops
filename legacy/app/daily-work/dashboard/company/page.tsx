 ...
 * @last-fix: [2026-01-24] Moved to /daily-work/dashboard/company
 */
...
export default function CompanyDashboard() {
  const { loading: authLoading, isManager, isAdmin, canViewConsolidatedView } = useAuth();
  ...
  useEffect(() => {
    if (!authLoading && (isManager || isAdmin)) {
      if (!canViewConsolidatedView()) {
        ...
        window.location.href = '/daily-work/dashboard/location';
        return;
      }
      fetchCompanyData();
    }
