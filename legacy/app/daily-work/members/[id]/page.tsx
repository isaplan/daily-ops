        ...
        <div className="bg-white border rounded-lg p-6 mb-6">
          ...
          {member.location_id && (
            <div className="mb-2">
              ...
              <a
                href={`/daily-work/locations/${member.location_id._id || member.location_id}`}
                onClick={(e) => {
                  e.preventDefault();
                  router.push(`/daily-work/locations/${member.location_id._id || member.location_id}`);
                }}
          ...
          {member.team_id && (
            <div className="mb-2">
              ...
              <a
                href={`/daily-work/teams/${member.team_id._id || member.team_id}`}
                onClick={(e) => {
                  e.preventDefault();
                  router.push(`/daily-work/teams/${member.team_id._id || member.team_id}`);
                }}
                className="text-blue-600 hover:text-blue-800"
              >
                {member.team_id.name}
