  ...
  >
    ...
    <nav class="flex-1 p-2 overflow-y-auto" :class="collapsed ? 'px-2' : 'p-4'">
      ...
      <ul v-if="activeEnvironment === 'daily-ops'" class="space-y-1">
        ...
        <li>
          <UTooltip v-if="collapsed" text="Hours V2" :popper="{ placement: 'right' }">
            <UDropdownMenu :items="hoursV2DropdownItems" :popper="{ placement: 'right-start' }">
              <button
                type="button"
                :class="navLinkClass(isHoursV2Section)"
          ...
          <button v-else
            ...
            :class="navLinkClass(isHoursV2Section)"
            class="w-full flex items-center"
            @click="isHoursV2Open = !isHoursV2Open"
          >
            <UIcon name="i-lucide-clock" class="size-4 shrink-0" />
            <span class="flex-1 text-left">Hours V2</span>
...
const hoursV2DropdownItems = computed(() => [
  [{
    label: 'Overview',
    to: '/daily-ops-v2/hours',
  }, {
    label: 'By Day',
...
const salesV2DropdownItems = computed(() => [
  [{
    label: 'Overview',
    to: '/daily-ops-v2/sales',
  }, {
    label: 'By Day',
    to: '/daily-ops-v2/sales/by-day',
  }, {
    label: 'By Hour',
    to: '/daily-ops-v2/sales/by-hour',
  }, {
    label: 'By Product',
    to: '/daily-ops-v2/sales/by-product',
  }, {
    label: 'By Worker',
    to: '/daily-ops-v2/sales/by-worker',
  }],
])
...
const isHoursSection = computed(() => route.path.startsWith('/daily-ops/hours') && !route.path.startsWith('/daily-ops-v3') && !route.path.startsWith('/daily-ops-v2'))
const isHoursV2Section = computed(() => route.path.startsWith('/daily-ops-v2/hours'))
...
const isSalesV2Section = computed(
  () => normalizedPath.value.startsWith('/daily-ops-v2/sales')
)
...
watch(() => route.path, (path: string) => {
  ...
  } else if (path.startsWith('/daily-ops-v2/hours')) {
    isHoursV2Open.value = true
  ...
  } else if (p.startsWith('/daily-ops-v2/sales')) {
