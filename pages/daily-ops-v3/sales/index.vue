<!--
 ...
 @last-fix: [2026-04-28] Moved to /daily-ops-v3/sales structure
 @page-route: /daily-ops-v3/sales
-->
  ...
  <div class="min-h-screen w-full min-w-0 flex-1 flex-col px-10 py-8 space-y-8">
    ...
    <div class="min-w-0">
      ...
      <p class="mt-2 text-sm text-gray-600">
        Detailed revenue analysis by day, hour, product, and waiter (V3 Aggregation)
      </p>
    </div>
