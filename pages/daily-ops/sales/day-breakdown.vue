...
// Last 7 days for quick selection
...
// Business day is 08:00 to 08:00
...
<template>
  <div class="space-y-6">
    ...
    <div>
      ...
      <p class="text-gray-500">Verify revenue calculations across all dimensions (hourly, worker, table, product)</p>
    </div>
      ...
      <UCard class="border-2 border-gray-900 !bg-white ring-0 shadow-none">
          ...
          <table class="w-full text-sm">
            ...
            <tbody>
              <tr v-for="hour in dayData?.hourly" :key="hour._id" class="border-b border-gray-100 hover:bg-gray-50">
                <td class="px-4 py-2 text-gray-900">{{ String(hour.hour).padStart(2, '0') }}:00</td>
        ...
        <div v-if="detailView === 'product'" class="overflow-x-auto">
          <table class="w-full text-sm">
            ...
            <tbody>
              <tr v-for="product in dayData?.product" :key="product._id" class="border-b border-gray-100 hover:bg-gray-50">
