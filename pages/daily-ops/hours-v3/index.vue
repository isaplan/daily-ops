<!--
 ...
 @last-modified: 2026-04-28T20:55:00.000Z
 @description: V3 labor analytics overview page - main entry for hours/labor V3 section
 @last-fix: [2026-04-28] Initial V3 hours index page
 @page-route: /daily-ops/hours-v3
-->
  ...
  <div class="min-h-screen w-full min-w-0 flex-1 flex-col px-10 py-8 space-y-8">
    ...
    <div class="min-w-0">
      ...
      <p class="mt-2 text-sm text-gray-600">
        Detailed labor hours analysis by day, hour, team, and contract
      </p>
    </div>
    ...
    <div class="rounded-lg bg-blue-50 border border-blue-200 p-6">
      ...
      <p class="text-sm text-blue-800 mt-2">
        These pages will provide deep dives into labor analytics with charts, tables, and filtering options.
      </p>
    </div>
