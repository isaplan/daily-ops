...
| `calendar_events` | App data | NL holidays, regio Midden school holidays, custom events | Event calendar for context | Seed script, weekly report UI | `weekly_reports` builder |
