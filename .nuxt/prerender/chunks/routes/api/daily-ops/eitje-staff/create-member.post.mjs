...
const createMember_post = defineEventHandler(async (event) => {
  var _a, _b;
  const body = await readBody(event);
  if (!((_a = body == null ? void 0 : body.employee_name) == null ? void 0 : _a.trim())) {
    throw createError({ statusCode: 400, statusMessage: "employee_name is required" });
  }
  if (!((_b = body == null ? void 0 : body.support_id) == null ? void 0 : _b.trim())) {
  ...
  } : { _id: String(result.insertedId), name: doc.name, email };
  return { success: true, data };
});

export { createMember_post as default };
//# sourceMappingURL=create-member.post.mjs.map
