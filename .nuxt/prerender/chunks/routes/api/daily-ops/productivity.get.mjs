...
import { d as resolveDailyOpsPeriod } from '../../../nitro/nitro.mjs';
...
const productivity_get = defineEventHandler((event) => {
...
export { productivity_get as default };
//# sourceMappingURL=productivity.get.mjs.map
