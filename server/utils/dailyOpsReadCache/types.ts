 ...
 * @description: Types for daily_ops_read_cache Mongo collection (legacy — all profiles retired)
 * @last-fix: [2026-08-09] Phase 7 complete — no active read-cache writers
...
/**
 * Legacy profile names. All retired — GET uses daily_ops_period_cache (PERIOD_CACHE_ADR).
 */
