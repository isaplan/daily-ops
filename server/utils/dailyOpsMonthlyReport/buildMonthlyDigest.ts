 ...
 *
 * @exports-to:
 * ✓ server/utils/monthlyReportDocument/buildMonthlyReportDocument.ts
 */
...
import { enumerateDaysInclusive } from '../dailyOpsWeeklyReport/weekRange'
...
export async function buildMonthlyDigest(
  ...
  return {
    ...
    dailyBreakdown: buildDailyBreakdown(dates, bundle.revenue, bundle.labor, bundle.products),
    teams,
    comparisons,
