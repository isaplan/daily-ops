...
const TITLES: Record<OpsNotificationKind, string> = {
  ...
  gmail_oauth_invalid_grant: 'Gmail disconnected (invalid_grant)',
  unparsed_basis_attachment: 'Basis attachment not parsed',
  integration_sync_partial_failure: 'Integration sync partial failure',
...
const SEVERITY: Record<OpsNotificationKind, OpsNotificationSeverity> = {
  ...
  gmail_oauth_invalid_grant: 'critical',
  unparsed_basis_attachment: 'warning',
  integration_sync_partial_failure: 'critical',
...
const CATEGORY: Record<OpsNotificationKind, OpsNotificationCategory> = {
  ...
  gmail_oauth_invalid_grant: 'cron',
  unparsed_basis_attachment: 'cron',
  integration_sync_partial_failure: 'cron',
