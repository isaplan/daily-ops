 ...
 * @last-fix: [2026-08-16] Also used by period-cache assemble (sealed byHour → cells)
 *   Prior: [2026-07-13] Updated metadata: Document today=order-time, sealed=paid-time basis rule + TODO shared resolver
 * @adr-ref: ADR-004
 *
 * @exports-to:
