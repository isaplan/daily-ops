/**
 * @registry-id: dailyOpsRevenuePerLocationSpaceGet
 * @last-modified: 2026-07-02T00:00:00.000Z
 * @description: Revenue per location space — read-cache target (ADR-013, reserved)
 * @last-fix: [2026-07-02] ADR-013 reserved read-cache metadata
 * @adr-ref: ADR-004, ADR-010, ADR-013
 * @data-source: read-cache (reserved - page not built yet)
 * @read-cache-json: daily_ops_read_cache · profile=revenue-per-location-space · levels=daily
 *
 * @exports-to:
